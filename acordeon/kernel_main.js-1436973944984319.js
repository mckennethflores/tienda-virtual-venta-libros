	...
	if (type == "icon")
	{
		element = BX.create('IMG', {
			props: {
				src: params.iconSrc
					? params.iconSrc
					: "hint.gif"/*tpa=http://www.palestraeditores.com/bitrix/js/main/core/images/hint.gif*/
			}
		});
	}
	else if (type == "link")
...
{
	return BX.ajax.loadJSON('http://www.palestraeditores.com/bitrix/tools/ajax_captcha.php', callback);
};
...
if(!phpVars)
{
	phpVars = {
		...
		LANGUAGE_ID: 'en',
		FORMAT_DATE: 'http://www.palestraeditores.com/bitrix/cache/js/s1/editorial/kernel_main/DD.MM.YYYY',
...
BX.CClockSelector.prototype.Show = function()
{
	if (!this.isReady)
	{
		...
		return BX.ajax.get('http://www.palestraeditores.com/bitrix/tools/clock_selector.php', {start_time: this.params.start_time, clock_id: this.CLOCK_ID, sessid: BX.bitrix_sessid()}, BX.delegate(this.Ready, this));
	}
