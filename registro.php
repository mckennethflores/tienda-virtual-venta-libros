...
if(!empty($_POST)){
	...
	if(isset($_POST["reg_nombre"])
	 ...
	 &&isset($_POST["reg_celular2"])
	 &&isset($_POST["reg_telefono"])
	 &&isset($_POST["reg_pais"])
	 &&isset($_POST["reg_direccion"])	
	 &&isset($_POST["reg_referencia"])	  
	 )
	 {
		if(
		$_POST["reg_nombre"]!=""&&
		...
		$_POST["reg_contrasena"]==$_POST["reg_rcontrasena"]
			...
			include "registroClientes/conexionregistro.php";
			...
			$query = $con->query($sql);
			if($query!=null){
				print "<script>alert(\"Registro exitoso. Proceda a logearse\");window.location='http://grijleimport.com/confirmar.php';</script>";
			}
		}
	}
}
