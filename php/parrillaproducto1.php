...
// mysqli_set_charset($conexion, "utf8");
 ...
 for($i =0; $i< $_SESSION['contador'];$i++){
	if($_SESSION['eliminado'][$i]=="N"){
		...
		$peticion = "SELECT * FROM libro WHERE idlibro=".$_SESSION['producto'][$i]."";
	 	$resultado = mysqli_query($conexion, $peticion);
	 	while($fila = mysqli_fetch_array($resultado)){
			$peticion2 = "SELECT * FROM imagenesproductos WHERE id = ".$fila['id']." LIMIT 1";
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="<?php echo $pgrijley; ?><?php echo $pcatotros; ?>"  class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li class="<?php echo $pgrijley; ?>"   > <a href="../productos-grijle.php">GRIJLEY EIRL</a></li>
...
for($i =0; $i< $_SESSION['contador'];$i++){	
	if($_SESSION['eliminado'][$i]=="N"){
	 ...
	 while($fila = mysqli_fetch_array($resultado)){		
		echo "<tr> ";
		$IMG=0;
		$peticion2 = "SELECT * FROM imagenesproductos WHERE id = ".$fila['idlibro']." LIMIT 1";
		$resultado2 = mysqli_query($conexion, $peticion2);
		while($fila2 = mysqli_fetch_array($resultado2)){
			echo " <td width='20%' align='center' valign='middle'>
			<div class='img imgcar'>
			<img width='70px' src='../img/".$fila2['imagen']."'>
			</div></td>";
			$IMG=1;
		...
		echo "  
		  <td width='35%' align='center' valign='middle'>".$fila['tlibro']."</td>
		  ...
		  <td width='10%' align='center' valign='middle'>
			  ...
			  <input type='text' name='cantidad' class='form-control' type='text' 
 ...
 <input name='codigoproducto' type='hidden' value='2301'>
                      <input name='foto' type='hidden' id='foto' value='../images/productos/ADMINISTRATIVO-CON-CD.jpg' size='3'>
                      <input name='precio' type='hidden' id='precio' value='' size='3'>
